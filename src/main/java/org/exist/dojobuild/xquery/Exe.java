...
public class Exe extends BasicFunction {
	private static String OS = System.getProperty("os.name").toLowerCase();
	public final static FunctionSignature signature =
	new FunctionSignature(
		new QName("exe", Module.NAMESPACE_URI, Module.PREFIX),
		"Exe javascript application from xquery.",
		new SequenceType[] {
			new FunctionParameterSequenceType("text", Type.STRING, Cardinality.ZERO_OR_MORE, "The profile to Exe")
		},
		new SequenceType(Type.ITEM, Cardinality.EMPTY));
	public Exe(XQueryContext context) {
	...
	public Sequence eval(Sequence[] args, Sequence contextSequence)
		...
		// TODO is argument the empty sequence?
	    try {
			...
			String baseUrl = dojohome + "/../util/buildscripts/build."+ext;
		    try {
		    	Process process = new ProcessBuilder(baseUrl,"-p","\""+dojohome+"/../"+strlist.get(0)+"\"").start();
		    	...
		    	throw new XPathException(this,Module.XDJB003,"Unknow error: "+e.toString());
		    } finally {
		    }
	    } catch(Exception e) {
	    	throw new XPathException(this,Module.XDJB003,"Unknow error: "+e.toString());
